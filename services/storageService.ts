  ...
  try {
    ...
    if (data) {
      ...
      return {
        ...
        bookingFlowUrl: parsed.bookingFlowUrl ?? '',
        fareEstimatorUrl: parsed.fareEstimatorUrl ?? '',
        customRequestUrl: parsed.customRequestUrl ?? '',
        promotionalOfferUrl: parsed.promotionalOfferUrl ?? '',
        couponProgramUrl: parsed.couponProgramUrl ?? '',
        loyaltyProgramUrl: parsed.loyaltyProgramUrl ?? '',
